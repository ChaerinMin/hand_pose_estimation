...
#         --use_optim_params --anchor_camera $ANCHOR_CAMERA
...
python scripts/mano_em.py -r $ROOT_DIR -s $SESSION -o $OUT_DIR \
        ...
        --use_filtered --use_optim_params --stride 1 --vis_smpl --to_smooth  --anchor_camera $ANCHOR_CAMERA # --save_mesh --vis_2d_repro --vis_3d_repro --save_frame