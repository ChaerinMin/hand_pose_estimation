...
def main(args):
    ...
    input_image_path = os.path.join(args.root_dir, args.seq_path)
    ...
    for image_dir in image_dirs:
        to_copy = os.path.basename(sorted(glob(f"{image_dir}/*.jpg"))[args.ith])
    ...
    logging.warning(f"Stored the parameters at {os.path.join(args.out_dir, 'params.txt')}")
